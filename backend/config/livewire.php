...
'temporary_file_upload' => [
    'disk' => null,        
    'rules' => 'file|max:102400', // UBAH INI: 102400 artinya 100MB (dalam Kilobytes)
    'directory' => null,
    'middleware' => null,
    'preview_mimes' => [
        'png', 'gif', 'bmp', 'jpg', 'jpeg', 'mp4', 'mov', 'avi', // Tambahkan format video
    ],
    'max_upload_time' => 5, // Tambahkan waktu jika internet lambat (dalam menit)
],
